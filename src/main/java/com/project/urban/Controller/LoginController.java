...
public class LoginController {
    ...
    @GetMapping("/baidangAndoid")
    public String viewbaidangAndroid() {
        return "baidangad";
    }

    @GetMapping("/donAndoid")
    public String viewdonAndroid() {
        return "donad";
    }

    @GetMapping("/homeAndoid")
    public String viewhomeAndroid() {
        return "homead";
    }
}
