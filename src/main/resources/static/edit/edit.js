  ...
  fetch("http://localhost:8081/api/users/") // Địa chỉ URL API của bạn
    ...
    .then((users) => {
      ...
      users.forEach((user) => {
        ...
        actionsCell.style.gap = "10px"; // Optional: add space between buttons

        // Create and style the edit button
        const editBtn = document.createElement("button");
        editBtn.className = "edit-btn";
        editBtn.style.backgroundColor = "#c79121";
        editBtn.style.borderRadius = "50%";
        editBtn.style.width = "40px"; // Adjust the size as needed
        editBtn.style.height = "40px";
        editBtn.style.display = "flex";
        editBtn.style.alignItems = "center";
        editBtn.style.justifyContent = "center";

        // Create and append the icon to the edit button
        ...
        deleteBtn.style.backgroundColor = "#a90329";
        deleteBtn.style.borderRadius = "50%";
        deleteBtn.style.width = "40px"; // Adjust the size as needed
        deleteBtn.style.height = "40px";
        deleteBtn.style.display = "flex";
        deleteBtn.style.alignItems = "center";
        deleteBtn.style.justifyContent = "center";

        // Create and append the icon to the delete button
        const deleteIcon = document.createElement("i");
        deleteIcon.className = "fa-solid fa-user-xmark";
